...
const ChurchAcquittancePage = ({
  ...
  const loadTransactions = async () => {
    setLoading(true);
    try {
      const result = await window.electron.churchAcquittance.getTransactions({
  ...
  const loadStatistics = async () => {
    try {
      const result = await window.electron.churchAcquittance.getStatistics({
        churchId: currentChurch.id,
        bookType: bookType
      });
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      const result = await window.electron.churchAcquittance.deleteTransaction({
...
export default ChurchAcquittancePage;
