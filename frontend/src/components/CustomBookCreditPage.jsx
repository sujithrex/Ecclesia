...
const CustomBookCreditPage = ({
  ...
  const handleAddTransaction = () => {
    navigate(isChurchLevel ? `/church-custom-book-credit/${bookId}/add?church=true` : `/custom-book-credit/${bookId}/add`);
  };

  const handleEditTransaction = (transaction) => {
    navigate(isChurchLevel ? `/church-custom-book-credit/${bookId}/edit/${transaction.id}?church=true` : `/custom-book-credit/${bookId}/edit/${transaction.id}`);
  };
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      const userId = localStorage.getItem('userId');
      const result = isChurchLevel
        ? await window.electron.churchCustomBookTransaction.deleteCreditTransaction({
            transactionId: transactionToDelete.id,
            userId: parseInt(userId),
          })
        : await window.electron.customBookTransaction.deleteCreditTransaction({
            transactionId: transactionToDelete.id,
            userId: parseInt(userId),
          });
  ...
  return (
    <div className={styles.container}>
      <Breadcrumb
        pageTitle={`Credit Vouchers - ${book?.book_name || 'Loading...'}`}
          ...
          <div className={styles.tableWrapper}>
            {loading ? (
              ...
              <div className={styles.emptyState}>
                ...
                <div className={styles.emptyStateText}>No credit vouchers found</div>
                <div className={styles.emptyStateSubtext}>Click "Add Transaction" to create your first credit voucher</div>
              </div>
            ) : (
...
export default CustomBookCreditPage;
