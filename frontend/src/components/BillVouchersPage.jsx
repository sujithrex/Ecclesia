...
const BillVouchersPage = ({
  ...
  const loadTransactions = async () => {
    setLoading(true);
    try {
      const result = await window.electron.billVoucher.getTransactions({
  ...
  const loadStatistics = async () => {
    try {
      const result = await window.electron.billVoucher.getStatistics({
        pastorateId: currentPastorate.id,
        bookType: bookType
      });
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      const result = await window.electron.billVoucher.deleteTransaction({
...
export default BillVouchersPage;
