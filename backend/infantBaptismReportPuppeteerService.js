...
class InfantBaptismReportPuppeteerService {
    constructor(db) {
        this.db = db;
        this.templatePath = path.join(__dirname, 'templates', 'infant_baptism_certificate.ejs');
        this.fontPath = path.join(__dirname, 'assets', 'fonts', 'Vijaya.ttf');
        this.imagePath = path.join(__dirname, 'assets', 'images', 'baptsm_infant.png');
    ...
    /**
     * Generate infant baptism certificate PDF using Puppeteer
    ...
    async generateCertificatePDF(certificate, church, options = {}) {
        ...
        try {
            ...
            console.error('❌ Error generating infant baptism certificate PDF:', error);
            return {
                success: false,
            ...
            try {
                ...
                win.webContents.on('did-finish-load', async () => {
                    try {
                        ...
                        // Generate PDF - Landscape orientation for infant baptism certificate
...
module.exports = InfantBaptismReportPuppeteerService;